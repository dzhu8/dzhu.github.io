...
import CraneAnimationDisplay from "../animations/CraneAnimationDisplay";

interface CraneAnimatedProjectCardProps {
     title?: string;
     languages?: string[];
     content?: string;
}

const CraneAnimatedProjectCard: React.FC<CraneAnimatedProjectCardProps> = ({
          ...
          <div className={`w-full max-w-6xl mx-auto ${isCompactLayout ? "flex-col space-y-4" : "flex gap-6"}`}>
               ...
               <div className={`${isCompactLayout ? "w-full max-w-md mx-auto" : "flex-none w-64"} flex flex-col`}>
                    <div className="bg-white p-4 shadow-lg flex flex-col border-2 border-gray-300 rounded-sm h-full flex-grow">
                         ...
                         >
                              <CraneAnimationDisplay
                                   width={isCompactLayout ? 180 : 220}
                                   height={isCompactLayout ? 140 : 180}
                                   craneScale={2.5}
                                   wingFlapSpeed={3.5}
               ...
               {/* Text editor (same as original TextEditWindow but simplified) */}
...
export default CraneAnimatedProjectCard;
