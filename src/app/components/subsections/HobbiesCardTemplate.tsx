...
const useResponsiveLayout = () => {
     ...
     useEffect(() => {
          const updateLayout = () => {
               ...
               const availableWidth = Math.min(currentWidth - (containerPadding * 2), containerMaxWidth - (containerPadding * 2));
...
const HobbiesCardTemplate: React.FC<HobbiesCardProps> = ({ 
     title, 
     imagePath, 
     description,
     titleFontSize
          ...
          <>
               {showDebugInfo && (
                    <div style={{
                         ...
                         <div>Card Size: {fixedCardWidth}x{fixedCardHeight}px</div>
